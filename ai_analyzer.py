...
def generate_report(data: dict) -> dict:
    ...
    prompt = f"""Ты — профессиональный финансовый аналитик. ВАЖНО: Весь ответ ТОЛЬКО на русском языке, без исключений. Даже если данные на английском — анализ, выводы и все текстовые поля пиши по-русски. Проанализируй акцию и составь отчёт строго в формате JSON.

...
Формат ответа:
{{
  "what_is_happening": "5-6 подробных абзацев, минимум 250 слов. Живым языком раскрой: текущую ситуацию в компании, недавние события и что они значат, положение относительно конкурентов, и на что обратить внимание в ближайшие месяцы. Не 'выручка выросла на X%', а 'компания последние полгода делала ставку на AI и это начинает окупаться'. Расскажи историю, а не сухие факты.",
